        ...
        isLoading ? (
          ...
          <Box m="20px">
            <div className='w-full flex justify-end'>
                <div className={`${styles.button} !w-[200px] dark:bg-[#57c7a3] !h-[35px] dark:border dark:border-[#fff]`}
            ...
            <Modal open={open} onClose={()=>setOpen(!open)} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 ">
                  ...
                  <div className='flex w-full items-center justify-between mb-6'>
                    <div className={`${styles.button} !w-[120px] h-[30px]`} onClick={()=>setOpen(!open)}>
                      Cancel

                    </div>
                    <div className={`${styles.button} !w-[120px] h-[30px]`} onClick={handleDelete}>
                      Delete
                    </div>
