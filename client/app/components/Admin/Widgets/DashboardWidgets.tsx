...
const DashboardWidgets:FC<Props> = ({open,value}) => {
    ...
    const [ordersComparePercentenge,setOrdersComparePercentenge]=useState<any>();
    ...
    useEffect(()=>{
        if(isLoading && ordersLoading){
            ...
            if(data && ordersData){
                const usersLastTwoMonths=data?.users?.last12Mounths?.slice(-2);
  ...
  return (
    <div className='mt-[30px] min-h-screen bg-black'>
            ...
            <div className='pt-[80px] pr-8'>
                <div className='w-full dark:bg-[#111C43] rounded-sm shadow'>
                    <div className=''>
                        ...
                        <h5 className='py-2 font-Poppins dark:text-[#45CDA0] text-black text-[20px] font-[400]'>
                            Sales Obtained
                        </h5>                     
                    </div>
                    <div>
                        <CircularProgressWithLabel value={
                            userComparePercentenge?.percentChange > 0 ? 100 :0
                        } open={open}/>
        ...
        <div className='grid grid-cols-[65%,35%] mt-[-20px]'>
            <div className='dark:bg-[#111c43] w-[94%] mt-[38px] h-[40vh] shadow-sm m-auto'>
