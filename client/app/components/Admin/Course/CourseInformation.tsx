        ...
        <div className='w-[80%] m-auto mt-24'>
            <form onSubmit={handleSubmit} className={`${styles.label}`}>
                ...
                <div className='mb-5'>
                    ...
                    <textarea name="" id="" cols={30} rows={8} placeholder='Write something amazing' className={`${styles.input} !h-min !py-2`} value={courseInfo.description} onChange={(e:any)=>setCourseInfo({...courseInfo,description:e.target.value})}>
                ...
                <div className='w-full flex justify-between'>
                    ...
                    <div className='w-[50%]'>
                        ...
                        <select name="" id="" className={`${styles.input} !text-slate-100 !bg-slate-800`} value={courseInfo.category} onChange={(e:any)=>setCourseInfo({...courseInfo,category:e.target.value})}>
